...
@@ -17,19 +16,16 @@ def check_first_name_value(self, expected_value):
...
@@ -39,7 +35,6 @@ def check_metro_value(self, station):
...
@@ -56,22 +51,18 @@ def set_rental_date(self):
...
@@ -86,8 +77,6 @@ def check_displaying_of_confirm_window(self):
